        ...
        <div className="relative z-10 w-full flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
              Empowering Schools <br className="hidden md:block" /> for a{" "}
              <span className="text-indigo-300">Brighter Future</span>
            </h1>
            <p className="text-lg md:text-xl mb-8">
              At Scolars United, we help build strong foundations for
              institutions through innovation, structured support, and holistic
              growth strategies.
            </p>
